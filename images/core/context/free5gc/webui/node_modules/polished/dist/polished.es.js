...
}, /*#__PURE__*/defineProperty(_opinionatedRules, 'a:active,\n  a:hover', {
  outlineWidth: '0'
}), /*#__PURE__*/defineProperty(_opinionatedRules, 'button,\n  input,\n  optgroup,\n  select,\n  textarea', {
  fontFamily: 'sans-serif',
  fontSize: '100%',
  lineHeight: '1.15'
}), _opinionatedRules);
...
var unopinionatedRules = (_unopinionatedRules = {
...
}, /*#__PURE__*/defineProperty(_unopinionatedRules, 'article,\n  aside,\n  footer,\n  header,\n  nav,\n  section', {
  display: 'block'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'h1', {
  fontSize: '2em',
  margin: '0.67em 0'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'figcaption,\n  figure,\n  main', {
  display: 'block'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'figure', {
  margin: '1em 40px'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'hr', {
  boxSizing: 'content-box',
  height: '0',
  overflow: 'visible'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'pre', {
  fontFamily: 'monospace, monospace',
  fontSize: '1em'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'a', {
  'background-color': 'transparent',
  '-webkit-text-decoration-skip': 'objects'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'abbr[title]', /*#__PURE__*/defineProperty({
  borderBottom: 'none',
  textDecoration: 'underline'
}, 'textDecoration', 'underline dotted')), /*#__PURE__*/defineProperty(_unopinionatedRules, 'b,\n  strong', {
  fontWeight: 'inherit'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'code,\n  kbd,\n  samp', {
  fontFamily: 'monospace, monospace',
  fontSize: '1em'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'dfn', {
  fontStyle: 'italic'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'mark', {
  backgroundColor: '#ff0',
  color: '#000'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'small', {
  fontSize: '80%'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'sub,\n  sup', {
  fontSize: '75%',
  lineHeight: '0',
  position: 'relative',
  ...
  bottom: '-0.25em'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'sup', {
  top: '-0.5em'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'audio,\n  video', {
  display: 'inline-block'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'audio:not([controls])', {
  display: 'none',
  height: '0'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'img', {
  borderStyle: 'none'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'svg:not(:root)', {
  overflow: 'hidden'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'button,\n  input,\n  optgroup,\n  select,\n  textarea', {
  margin: '0'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'button,\n  input', {
  overflow: 'visible'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'button,\n  select', {
...
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'button::-moz-focus-inner,\n  [type="button"]::-moz-focus-inner,\n  [type="reset"]::-moz-focus-inner,\n  [type="submit"]::-moz-focus-inner', {
  borderStyle: 'none',
  padding: '0'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'button:-moz-focusring,\n  [type="button"]:-moz-focusring,\n  [type="reset"]:-moz-focusring,\n  [type="submit"]:-moz-focusring', {
  outline: '1px dotted ButtonText'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'fieldset', {
  border: '1px solid #c0c0c0',
  margin: '0 2px',
  padding: '0.35em 0.625em 0.75em'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'legend', {
  ...
  padding: '0',
  whiteSpace: 'normal'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'progress', {
  display: 'inline-block',
  verticalAlign: 'baseline'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'textarea', {
  overflow: 'auto'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '[type="checkbox"],\n  [type="radio"]', {
  boxSizing: 'border-box',
  padding: '0'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '[type="number"]::-webkit-inner-spin-button,\n  [type="number"]::-webkit-outer-spin-button', {
  height: 'auto'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '[type="search"]', {
  '-webkit-appearance': 'textfield',
  outlineOffset: '-2px'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '[type="search"]::-webkit-search-cancel-button,\n  [type="search"]::-webkit-search-decoration', {
  '-webkit-appearance': 'none'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '::-webkit-file-upload-button', {
  '-webkit-appearance': 'button',
  font: 'inherit'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'details,\n  menu', {
  display: 'block'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'summary', {
  display: 'list-item'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'canvas', {
  display: 'inline-block'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, 'template', {
  display: 'none'
}), /*#__PURE__*/defineProperty(_unopinionatedRules, '[hidden]', {
  display: 'none'
}), _unopinionatedRules);
...
var _templateObject = /*#__PURE__*/ taggedTemplateLiteral(['radial-gradient(', '', '', '', ')'], ['radial-gradient(', '', '', '', ')']);
