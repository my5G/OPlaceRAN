...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Times) DeepCopyInto(out *Times) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Times.
func (in *Times) DeepCopy() *Times {
	if in == nil {
		return nil
	}
	out := new(Times)
